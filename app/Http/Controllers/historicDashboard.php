...
class historicDashboard extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Define shifts
        $shifts = [
            'Morning' => ['start' => '06:00:01', 'end' => '14:00:00'],
            'Afternoon' => ['start' => '14:00:01', 'end' => '22:00:00'],
            'Night' => ['start' => '22:00:01', 'end' => '06:00:00'],
        ];
        ...
        $commandes = DB::table('ligne_commande')
            ...
            CASE 
                ...
                ELSE "Night"
            END AS shift,
            SUM(quantity) as total_commandes
        ')
